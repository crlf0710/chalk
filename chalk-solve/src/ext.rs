...
pub trait CanonicalExt<T: HasInterner, I: Interner> {
    fn map<OP, U>(self, interner: &I, op: OP) -> Canonical<I, U::Result>
    where
...
impl<T, I> CanonicalExt<T, I> for Canonical<I, T>
where
...
pub trait GoalExt<I: Interner> {
    fn into_peeled_goal(self, interner: &I) -> UCanonical<I, InEnvironment<Goal<I>>>;
    fn into_closed_goal(self, interner: &I) -> UCanonical<I, InEnvironment<Goal<I>>>;
}
